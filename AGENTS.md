...
This repository currently contains planning artifacts only. Resolve an issue's
expected paths against the real tree when implementation starts. Keep exactly
three application projects in the final submission. Use feature/ branches for
implementation; main currently carries the planning baseline.
