...
{
    public static ApiResponseModel Ok(RecordBusinessModel record) => new(true, "Success", new ResourceResponseModel(record), []);
    public static ApiResponseModel List(PageBusinessModel page) => new(true, "Success", page.Items.Select(x => new ResourceResponseModel(x)).ToArray(), [],
